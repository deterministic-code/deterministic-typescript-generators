...
type TsCtx = EmitCtx<TsEmitOptions, TypescriptImports>;

export const DEFAULT_EMIT_OPTIONS: TsEmitOptions = {
...
function emitField(field: DatasourceField, ctx: TsCtx): string {
...
function renderTable(table: NormalizedTable, ctx: TsCtx): EmittedFile {
...
const baseEmit = datasourceTypesEmitter(
  normalizeTable,
  renderTable,
  indexLine,
)(TypescriptImports);
