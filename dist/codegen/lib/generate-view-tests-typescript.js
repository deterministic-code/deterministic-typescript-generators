...
export function generateForView({ view, viewTypes, datasource, options = DEFAULT_GENERATE_OPTIONS, }) {
...
export function generateFromSchema({ viewTypes, datasource }, options = DEFAULT_GENERATE_OPTIONS) {
    ...
    return normalized.map((v) => generateForView({ view: v, viewTypes, datasource, options: opts }));
}
