...
/** The shared setup frontend_types and its test emitter both start from: parse the view + datasource YAML, build the OpenAPI component oracle, and resolve the settings-driven name/field casing + datetime representation. Returns `{ components, names, fields, datetime }` so both derive the read-type surface one way and can't drift. */
export declare function buildFrontendComponents({ inputs, settings }: EmitArgs): Promise<{
