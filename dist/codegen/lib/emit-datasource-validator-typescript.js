...
import { entryOf, isFiniteInt, } from "@deterministic-code/generator-sdk/emitter-shared";
...
import { STANDARD_COLUMNS, } from "@deterministic-code/generator-sdk/codegen/lib/datasource-validator-emit-types";
...
const baseCreateEmitter = datasourceValidatorEmitter(renderTable, indexLine);
