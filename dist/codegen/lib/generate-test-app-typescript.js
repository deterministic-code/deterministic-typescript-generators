...
export function generateTestApp({ datasourceData, routesData, viewTypesData, factoryName = "createTestApp", pluralizeTableNames = true, datetime = "native", uuid = "native", idType = "integer", libraryReferenceMode, organizeByFeature = false, }) {
