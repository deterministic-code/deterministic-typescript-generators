...
export function generatePerfServerTypescript({ datasourceData, libraryReferenceMode, } = {}) {
    if (!datasourceData || typeof datasourceData !== "object") {
        throw new Error("generatePerfServerTypescript: datasourceData is required (parsed datasource_types.yaml)");
    }
    if (!Array.isArray(datasourceData.types)) {
        throw new Error("generatePerfServerTypescript: datasourceData.types must be an array — malformed datasource_types.yaml");
    }
