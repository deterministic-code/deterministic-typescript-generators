import { accessExpr, distinctNextTs, } from "@deterministic-code/generator-sdk/codegen/lib/ts-sample-literal";
...
export function renderFieldAccessorCases({ className, serializedFixture, entries, nullableNames, }) {
    const cases = [];
