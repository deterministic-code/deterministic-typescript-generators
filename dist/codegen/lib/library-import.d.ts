...
export declare function libraryImportSpecifier(subpath: string, mode: string | undefined, generatedFileRelToProjectRoot: string): string;
...
export declare function rewriteLibraryImports(source: string, mode: string | undefined, generatedFileRelToProjectRoot: string): string;
