...
import { buildViewEmitter, shapedViewDocLines, unionViewDocLines, } from "@deterministic-code/generator-sdk/codegen/lib/emit-view-shared";
...
function renderView(view, ctx) {
    ...
    const emitPath = ctx.layout.filePath(view.name, "view-type");
